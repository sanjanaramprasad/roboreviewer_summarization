...
logger = TensorBoardLogger('tb_logs', name='my_model_epoch_linearize_modification%s_%s'%(str(max_epochs), str(learning_rate)))
...
class LitModel(pl.LightningModule):
    ...
    def freeze_embeds(self):
        ...
        for d in [self.model.encoder, self.model.encoder1, self.model.encoder2,
            self.model.encoder3, self.model.encoder4, self.model.decoder1]:
