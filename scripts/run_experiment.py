...
logger = TensorBoardLogger('tb_logs_final', name='my_model_final_epoch%s_%s_addition'%(str(max_epochs), str(learning_rate)))
...
def main():
    ...
    checkpoint = ModelCheckpoint('checkpoint_files_final/3e-5_addition/',
