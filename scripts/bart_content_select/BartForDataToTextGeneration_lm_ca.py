...
from transformers.models.bart.modeling_bart import BartEncoder, BartDecoder, BartAttention, BartPretrainedModel, shift_tokens_right, BartDecoderLayer, BartLearnedPositionalEmbedding,  _make_causal_mask, _expand_mask
...
class BartDecoderLayerMulti(nn.Module):
    ...
    def __init__(self, config : BartConfig):
        ...
        self.encoder_attn_layer_norm3 = nn.LayerNorm(self.embed_dim)
    ...
    def forward(
        ...
        hidden_states_0 = hidden_states_0 + residual
        hidden_states_0 = self.encoder_attn_layer_norm(hidden_states_0)
        residual_hidden_states_0 = hidden_states_0
        ...
        hidden_states_1 = hidden_states_1 + residual
        hidden_states_1 = self.encoder_attn_layer_norm1(hidden_states_1)
        residual_hidden_states_1 = hidden_states_1
        ...
        hidden_states_2 = hidden_states_2 + residual
        hidden_states_2 = self.encoder_attn_layer_norm2(hidden_states_2)
        ...
        present_key_value = present_key_value + cross_attn_present_key_value_0 + cross_attn_present_key_value_1 + cross_attn_present_key_value_2 + cross_attn_present_key_value_3 

        # Fully Connected
        hidden_states_0 = self.activation_fn(self.fc1(hidden_states_0))
        hidden_states_0 = F.dropout(hidden_states_0, p=self.activation_dropout, training=self.training)
        hidden_states_0 = self.fc2(hidden_states_0)
        hidden_states_0 = F.dropout(hidden_states_0, p=self.dropout, training=self.training)
        hidden_states_0 = residual_hidden_states_0 + hidden_states_0
        hidden_states_0 = self.final_layer_norm(hidden_states_0)

        hidden_states_1 = self.activation_fn(self.fc1(hidden_states_1))
        hidden_states_1 = F.dropout(hidden_states_1, p=self.activation_dropout, training=self.training)
        hidden_states_1 = self.fc2(hidden_states_1)
        hidden_states_1 = F.dropout(hidden_states_1, p=self.dropout, training=self.training)
        hidden_states_1 = residual_hidden_states_1 + hidden_states_1
        hidden_states_1 = self.final_layer_norm(hidden_states_1)

        hidden_states_2 = self.activation_fn(self.fc1(hidden_states_2))
        hidden_states_2 = F.dropout(hidden_states_2, p=self.activation_dropout, training=self.training)
        hidden_states_2 = self.fc2(hidden_states_2)
        hidden_states_2 = F.dropout(hidden_states_2, p=self.dropout, training=self.training)
        hidden_states_2 = residual_hidden_states_2 + hidden_states_2
        hidden_states_2 = self.final_layer_norm(hidden_states_2)

        hidden_states_3 = self.activation_fn(self.fc1(hidden_states_3))
        hidden_states_3 = F.dropout(hidden_states_3, p=self.activation_dropout, training=self.training)
        hidden_states_3 = self.fc2(hidden_states_3)
        hidden_states_3 = F.dropout(hidden_states_3, p=self.dropout, training=self.training)
        hidden_states_3 = residual_hidden_states_3 + hidden_states_3
        hidden_states_3 = self.final_layer_norm(hidden_states_3)

        outputs = (hidden_states_0, hidden_states_1, hidden_states_2, hidden_states_3)
