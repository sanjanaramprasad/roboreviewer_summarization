...
#return_val = ret.json()
#print(return_val)
data_relations = get_file_relations('bart_average_outputs.txt')
##print(data_relations)
data_relations_targets = get_file_relations('bart_average_ref.txt')

model_outputs = read_file('bart_average_outputs.txt')
targets = read_file('bart_average_ref.txt')
